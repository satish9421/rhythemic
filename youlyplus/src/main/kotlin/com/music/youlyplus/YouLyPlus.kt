...
object YouLyPlus {
    ...
    /**
     * Collect all lyrics options across servers;
     * invokes [callback] for each distinct non-blank result. Each server is queried in parallel;
     * callbacks are delivered as results arrive.
     */
