...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: com.j.rhythemic.ui.component.LyricsGlassStyle? = null,
        ...
        val style = glassStyle ?: com.j.rhythemic.ui.component.LyricsGlassStyle.FrostedDark
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Rhythemic")
            }
