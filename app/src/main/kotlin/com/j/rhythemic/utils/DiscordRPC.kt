...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val PAUSE_IMAGE_URL =
            "https://raw.githubusercontent.com/JAY01-CYBER/M3-Play/main/fastlane/metadata/android/en-US/images/RPC/pause_icon.png"
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/JAY01-CYBER/M3-Play/main/fastlane/metadata/android/en-US/images/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Rhythemic"
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/JAY01-CYBER/M3-Play"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.j.rhythemic.utils.GlobalLog.append(
