package com.j.rhythemic.ui.screens.search.suggestions
...
import com.j.rhythemic.models.toMediaMetadata // FIX: Added missing import
    ...
    fun navigateToAlbum(album: SuggestionAlbum, navController: NavController) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            YouTube.search(query, YouTube.SearchFilter.FILTER_ALBUM).onSuccess { searchResult ->
                val firstAlbum = searchResult.items.filterIsInstance<com.j.rhythemic.innertube.models.AlbumItem>().firstOrNull()
