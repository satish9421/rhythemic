...
import com.j.rhythemic.constants.QueueEditLockKey
...
import com.j.rhythemic.ui.component.MediaMetadataListItem
import com.j.rhythemic.ui.menu.PlayerMenu
import com.j.rhythemic.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.j.rhythemic.together.TogetherSessionState.Joined &&
            (togetherSessionState as com.j.rhythemic.together.TogetherSessionState.Joined).role is com.j.rhythemic.together.TogetherRole.Guest
                                                ...
                                                onClick = {
                                                    if (selection) {
                                                        ...
                                                        if (index == currentWindowIndex) {
                                                            ...
                                                            val joined = togetherSessionState as? com.j.rhythemic.together.TogetherSessionState.Joined
                                                            val isGuest = joined?.role is com.j.rhythemic.together.TogetherRole.Guest
                                                            if (isGuest) {
