...
class M3VinylWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.j.rhythemic.widget.ACTION_PLAY_PAUSE"
        const val ACTION_LIKE = "com.j.rhythemic.widget.ACTION_LIKE" // Yahan Like action add kiya
    }
